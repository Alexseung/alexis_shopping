...
export default function mainCategory() {
  ...
  return (
    <div className='border border-red-500 h-auto my-3'>
      ...
      <div className='grid grid-cols-2 justify-items-center mx-32'>
        ...
        <div className='my-6'>
          <p className='text-center font-semibold text-2xl'>Beauty</p>
          <img
            src='https://img.hankyung.com/photo/202403/AA.36104679.1.jpg'
            alt=''
            className='border border-blue-700 rounded-full mb-10 w-52 h-52 hover:cursor-pointer'
            onClick={() => goToPage('beauty')}
          />
        </div>
        <div className='my-6'>
          <p className='text-center font-semibold text-2xl'>Living</p>
          <img
            src='https://img.hankyung.com/photo/202403/AA.36104679.1.jpg'
            alt=''
            className='border border-blue-700 rounded-full mb-10 w-52 h-52 hover:cursor-pointer'
            onClick={() => goToPage('living')}
          />
        </div>
      </div>
    </div>
